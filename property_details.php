...
<main class="container">
  <div class="property-header">
    ...
    <div class="property-meta">
      ...
      <?php else: ?>
        <?php if (is_logged_in()): ?>
          <?php if (isset($_SESSION['user_id']) && $_SESSION['user_id'] == $prop['owner_id']): ?>
            <p class="muted" style="margin-top:12px">To jest Twoje mieszkanie.</p>
          <?php else: ?>
            <div style="margin-top:12px">
              <a class="btn btn-primary" href="book_property.php?id=<?=intval($id)?>">Rezerwuj</a>
            </div>
          <?php endif; ?>
        <?php else: ?>
          <div style="margin-top:12px">
            <p>Aby zarezerwować to mieszkanie, <a class="btn btn-primary" href="login.php">zaloguj się</a> lub <a href="register.php">zarejestruj</a>.</p>
          </div>
        <?php endif; ?>
      <?php endif; ?>
